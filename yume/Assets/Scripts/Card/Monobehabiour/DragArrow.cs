...
public class DragArrow : MonoBehaviour
{
    ...
    public void SetArrowPosition()
    {
        ...
        //设置控制点的偏移量
        Vector3 offset = perpendicular * arcModifier; //你可以调整这个值来改变贝塞尔曲线的形状
        
        Vector3 controlPoint = (cardPosition + mousePos) / 2 + offset; //贝塞尔曲线控制点


        lineRenderer.positionCount = pointsCount; //设置线渲染器的点数量
